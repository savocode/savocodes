...
<head>
  ...
  <title>{{ constants('global.site.name') }} | Reset Password</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ url('/') }}">{{ constants('global.site.name') }}</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">One last step to reset your password..</p>

    <form role="form" method="POST" action="{{ route('backend.password.final') }}">
        {{ csrf_field() }}
    ...
    <a href="{{ backend_url('login') }}">Got your credentials? Log-in</a>
