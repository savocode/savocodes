...
<div class="row">
    <div class="col-sm-6 form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
        ...
        {!! Form::text('phone', isset($employee->phone)?$employee->phone_decrypted:old('phone'), ['class' => 'form-control']) !!}
        @if ($errors->has('phone'))
            <span class="help-block">
...
<div class="pull-left">
    ...
    <a href="{{ backend_url($moduleProperties['controller'].'/'.$hospital->id.'/employees') }}" type="button" class="btn btn-default btn-flat">Cancel</a>
</div>
